...
export default function Index() {
  const {
    ...
    updateAnimation, updateAudio, updateWatermark, updateTitleOverlay, updateOverlay, updateEnding, updateLyrics,
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-card">
          ...
          <div className="shrink-0 border-t border-border bg-excel-header p-2 md:p-3 space-y-1.5 md:space-y-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
              <button onClick={() => setShowMobileEditor(!showMobileEditor)} className="md:hidden px-3 py-1.5 text-[10px] font-medium border border-border bg-card hover:bg-excel-hover rounded transition-colors">
